...
import com.study.dao.BoardsMapper;
import com.study.dto.Boards;
import com.study.dto.Files;
import com.study.util.ByteCalcuation;
        ...
        if(!files[0].isEmpty()){
            for(MultipartFile mf : files){
                if(!mf.isEmpty()) {
                    ...
                    String path = "C:\\Users\\user\\IdeaProjects\\study\\src\\main\\webapp\\WEB-INF\\uploadFiles\\";
        ...
        if(!imgFiles[0].isEmpty()){
            for(MultipartFile mf : imgFiles){
                if(!mf.isEmpty()) {
                    ...
                    String path = "C:\\Users\\user\\IdeaProjects\\study\\src\\main\\resources\\static\\assets\\images\\uploadimages\\image\\";
